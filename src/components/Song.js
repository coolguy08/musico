      ...
      <>
        <Wrapper>
          <ImageWrapper padding="30px 0 0 0">
             <Image src={song.image} width="200px" height="200px"/>
          </ImageWrapper>
          ...
          <Text color="white" family="Poppins" size="1.2em" padding="10px 0 0 20px">{song.title}</Text>
          <Text color="gray" family="Poppins" size="0.9em" padding="5px 0 0 20px">{song.header_desc}</Text>
          ...
          <Text color="gray" family="Poppins" size="0.8em">{parseInt(song.play_count).toLocaleString('en-US')} Plays</Text>
          </Flexbox>
         ...
         {/* Bottom footer */}
         <Footer>
           <Text color="gray" family="Poppins" size="0.8em">{new Date(song.more_info.duration).toISOString().substr(14, 5)}</Text>
           <Text color="gray" family="Poppins" size="0.8em">{song.more_info.copyright_text}</Text>
         </Footer>
